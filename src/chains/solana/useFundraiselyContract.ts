/**
 * Fundraisely Contract Hook - Complete Implementation
 *
 * Idiomatic TypeScript/React hooks for interacting with Fundraisely Solana program.
 * Uses Anchor framework for type-safe contract interaction with comprehensive error handling.
 *
 * Architecture:
 * - Memoized provider and program instances for performance
 * - Transaction simulation before sending to catch errors early
 * - Proper PDA derivation following Solana best practices
